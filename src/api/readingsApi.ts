...
function docToReading(doc: unknown): YieldReading | null {
  try {
    ...
    return {
      ...
      mwdInc: data.mwdInc != null ? Number(data.mwdInc) : null,
      mwdAz: data.mwdAz != null ? Number(data.mwdAz) : null,
      mwdBr: data.mwdBr != null ? Number(data.mwdBr) : null,
      mwdTr: data.mwdTr != null ? Number(data.mwdTr) : null,
      mwdDls: data.mwdDls != null ? Number(data.mwdDls) : null,
      ...
      resultantTF: data.resultantTF != null ? Number(data.resultantTF) : null,
